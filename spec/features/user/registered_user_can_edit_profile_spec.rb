...
feature "a registered user can edit profile" do
  ...
  xscenario "registered customer can login and edit profile with correct information" do
    visit root_path
  ...
  xscenario "registered customer can't edit profile without a full name" do
    visit root_path
    click_link("Login")
    fill_in "session[email]", with: "tslice@gmail.com"
    fill_in "session[password]", with: "password"
  ...
  xscenario "registered customer can't edit profile without a email" do
    visit root_path
    click_link("Login")
    fill_in "session[email]", with: "tslice@gmail.com"
    fill_in "session[password]", with: "password"
